...
import SystemLightStatusBarDefault from "../SystemLightStatusBarDefault";
        ...
        <div className="container-18">
          ...
          <div className="adva">
            ...
            <div className="advantage-item-5">
              <img className="icon-clock-1" src="/img/icon-sber-time@2x.svg" alt="icon-clock" />
              <div className="container-19">
                <TitleSubtitle title={titleSubtitleProps.title} subtitle={titleSubtitleProps.subtitle} />
              </div>
              <img className="ic-question-circle-1" src="/img/ic-question-circle@2x.svg" alt="ic question-circle" />
            </div>
            <AdvantageItem4
      ...
      <div className="about">
        <div className="frame-270988950">
          ...
          <div className="container-20">
            <img className="image-doc-chips-1" src="/img/image-doc-chips@2x.svg" alt="Image Doc Chips" />
