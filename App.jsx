...
import X414px from "./components/X414px";
...
const cmalePhone1Data = {
    src: "/img/boy-telefon-1-1@1x.png",
};
...
const otherchandsPhone1Data = {
    src: "/img/lg-hands-phone-01-2x-1@1x.png",
};
...
const imageSm1Data = {
    src: "/img/ic-sber-profile-1@2x.svg",
    className: "",
};
...
const imageSm2Data = {
    src: "/img/ic-sber-signed-1@2x.svg",
    className: "",
};
...
const imageSm3Data = {
    src: "/img/icon-sber-send-1@2x.svg",
    className: "image-sm",
};
...
const otherchandsPhone2Data = {
    src: "/img/lg-hands-phone-01-2x@2x.png",
    className: "otherchands-phone-1",
};

const imageSm4Data = {
    src: "/img/ic-sber-profile@2x.svg",
    className: "",
};
